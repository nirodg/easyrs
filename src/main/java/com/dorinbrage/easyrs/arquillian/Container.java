package com.dorinbrage.easyrs.arquillian;
...
import com.dorinbrage.easyrs.client.RestClient;
...
public abstract class Container<T, E> {
  ...
  private void initializeJaxRsClient() {
    ...
    if (System.getProperty(SYSPROP_CLIENT_USER) != null
        || System.getProperty(SYSPROP_CLIENT_PASS) != null) {
  ...
  /**
   * For each test will be printed either the test started, passed successfully or it failed.
   */
  @Rule
  public TestWatcher currentTestWatcher = new TestWatcher() {
    @Override
    protected void starting(org.junit.runner.Description description) {
      System.out.println("---- starting test case: " + description.getClassName() + "."
          + description.getMethodName());
    };

    @Override
    protected void finished(org.junit.runner.Description description) {
      System.out.println("---- finished test case: " + description.getClassName() + "."
          + description.getMethodName());
    };
